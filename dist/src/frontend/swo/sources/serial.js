...
class SerialSWOSource extends events_1.EventEmitter {
    constructor(device, baudRate, extensionPath) {
        ...
        try {
            ...
            vscode.window.showErrorMessage('Unable to load Serial Port Module. A recent Visual Studio Code update has likely broken compatibility with the serial module. Please visit https:// for more information.');
            return;
        }

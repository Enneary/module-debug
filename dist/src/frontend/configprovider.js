...
class ModuleDebugConfigurationProvider {
    constructor(context) {
    ...
    resolveDebugConfiguration(folder, config, token) {
        ...
        const configuration = vscode.workspace.getConfiguration('module-debug');
...
exports.ModuleDebugConfigurationProvider = ModuleDebugConfigurationProvider;
